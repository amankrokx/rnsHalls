...
- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to rnsHalls.
...
- __Website__ refers to rnsHalls, accessible from [https://rnshalls.web.app](https://rnshalls.web.app)
